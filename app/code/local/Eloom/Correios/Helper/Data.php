...
class Eloom_Correios_Helper_Data extends Mage_Core_Helper_Abstract
{
	...
	const XML_CORREIOS_CD_EMPRESA = 'carriers/eloom_correios/cd_empresa';
	const XML_CORREIOS_DS_SENHA = 'carriers/eloom_correios/ds_senha';
	...
	const XML_CORREIOS_CD_AVISO_RECEBIMENTO = 'carriers/eloom_correios/cd_aviso_recebimento';
	...
	const XML_CORREIOS_CD_MAO_PROPRIA = 'carriers/eloom_correios/cd_mao_propria';
	...
	{
		return Mage::getStoreConfig(self::XML_CORREIOS_CD_EMPRESA);
	}

	public function getSenhaAcesso()
	{
		return Mage::getStoreConfig(self::XML_CORREIOS_DS_SENHA);
	}
	...
	public function isAvisoRecebimento()
	{
		return Mage::getStoreConfigFlag(self::XML_CORREIOS_CD_AVISO_RECEBIMENTO);
	}
	...
	public function isMaoPropria()
	{
		return Mage::getStoreConfigFlag(self::XML_CORREIOS_CD_MAO_PROPRIA);
	}
